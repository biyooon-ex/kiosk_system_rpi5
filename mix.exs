defmodule KioskSystemRpi5.MixProject do
  use Mix.Project

  @github_organization "biyooon-ex"
  @app :kiosk_system_rpi5
  ...
  defp package do
    [
      ...
      links: %{
        "GitHub" => @source_url,
        "REUSE Compliance" =>
          "https://api.reuse.software/info/github.com/nerves-web-kiosk/kiosk_system_rpi5"
      }
    ]
  end
